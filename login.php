...
<head>
  ...
  <title>CERTIFICATE VERIFICATION SYSTEM | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#" style="color: #fff;"><b>CERTIFICATE VERIFICATION SYSTEM</b>&nbsp;&nbsp;<i class="fa fa-th-large fa-2x"></i></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
...
<div class="social-auth-links text-center mb-4">
        ...
        <br/><a href="index.html" style="text-decoration: none;">
                Go back to home?
