        ...
        <div class="row">
          <div class="col-md-12">
           <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="add-course.php" method="post">
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputName" placeholder="Please enter course name" required="required">
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary col-md-3" name="submit">Add Course</button>
